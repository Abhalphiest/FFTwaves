...
class skybox
{
	...
	// the order MATTERS
	char* faces[6] = {"skybox/nightsky_right.png","skybox/nightsky_left.png","skybox/nightsky_top.png","skybox/nightsky_bottom.png",
		"skybox/nightsky_back.png", "skybox/nightsky_front.png" };
public:
